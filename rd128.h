...
uint32_t RD128::rotate_l(uint32_t x, unsigned int n)
{
	return (x << n) | (x >> 32 - n);
}

uint32_t RD128::F(uint32_t x, uint32_t y, uint32_t z)
{
	return x ^ y ^ z;
}

uint32_t RD128::G(uint32_t x, uint32_t y, uint32_t z)
{
	return (x & y) | (~x & z);
}

uint32_t RD128::H(uint32_t x, uint32_t y, uint32_t z)
{
	return (x | ~y) ^ z;
}

uint32_t RD128::I(uint32_t x, uint32_t y, uint32_t z)
{
	return (x & z) | (y & ~z);
}

void RD128::FF(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + F(b, c, d) + X[k]), s);
}

void RD128::GG(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + G(b, c, d) + X[k] + 0x5a827999), s);
}

void RD128::HH(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + H(b, c, d) + X[k] + 0x6ed9eba1), s);
}

void RD128::II(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + I(b, c, d) + X[k] + 0x8f1bbcdc), s);
}

void RD128::FFF(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + F(b, c, d) + X[k] + 0x00000000), s);
}

void RD128::GGG(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + G(b, c, d) + X[k] + 0x6d703ef3), s);
}

void RD128::HHH(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
	a = rotate_l((a + H(b, c, d) + X[k] + 0x5c4dd124), s);
}

void RD128::III(uint32_t &a, uint32_t b, uint32_t c, uint32_t d, unsigned int k, unsigned int s)
{
...
void RD128::compose(const char *str, unsigned int length)
{
...
void RD128::decode(uint32_t *output, unsigned char input[], unsigned int len)
{
...
void RD128::encode(unsigned char *output, const uint32_t input[], unsigned int len)
{
	for (unsigned int i = 0, j = 0; j < len; i++, j += 4) 
	{
